...
<body style="background-color:#e6ecff;">
  ...
  <div class="slider">
    ...
    <div class="slide">
      <img src="https://assets.losspreventionmedia.com/uploads/2019/10/Lawyer-gavel-legal-1280x720.jpg" alt="">
      <div class="info">
        <h2>Credentials</h2>
        <p>Handle our own Credentials in secure and safe way</p>
      </div>
    </div>
    <div class="slide">
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <div class="feature-img">
            <img
              src="https://images.unsplash.com/photo-1590099543482-3b3d3083a474?ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8bGF3fGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&w=1000&q=80"
              alt="Feature">
          </div>
        </div>
      </div>
  ...
  <section data-aos="fade-down" class="text-gray-600 body-font relative content" id="contactus" >
    <div class=" container px-5 py-24 mx-auto " style="display:block; justify-content:center;">

      <div class="flex flex-col text-center w-full mb-12" >
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
        <p style="color: black; font-size:x-large;" class="lg:w-2/3 mx-auto leading-relaxed text-base">Enter the
          Following Details and we would revert back as
          soon as possible</p>
      </div>
      ...
      <form style="display:flex; justify-content:center;" method="POST"  action="contactUsStore">
      <?php echo csrf_field(); ?>
        <div class="lg:w-1/2 md:w-2/3 mx-auto" style=" justify-content:center;">
          <div class="flex flex-wrap -m-2" style=" justify-content:center;">
            <div style="display:flex;">
              <div class="p-2 w-1/2">
                <div class="relative">
                  <label style="display:block;color: black; font-size:large;" for="name"
                    class="leading-7 text-sm text-gray-600">Name</label>
                  <input type="text" id="name" name="name"
                    style="width: 306px;height: 54px;border-radius: 7px;padding: 20px;border-color: azure;" 
            ...
            <div style="display:flex;"> -->
              <div class="p-2 w-1/2">
                <div class="relative">
                  <label style="display:block;color: black; font-size:large;" for="email"
            ...
            <div>
              <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <div style="display:block;justify-content:center;align-items:center;">
                  <div>
                    <label style="display:flex;color: black; font-size:large;" for="message"
                      class="leading-7 text-sm text-gray-600">Message</label>
                  </div>
                  <div>
                    <textarea id="message" name="message"
                      style="padding: 20px;border-color: azure;max-height: 200px;min-height: 100px;width: 630px;align-items: center;justify-items: center;height: 89px;border-radius: 7px;"
                      placeholder="Descpriction of your Case" required></textarea>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a style=" font-size:larger;" class="text-indigo-500">lawyer@email.com</a>
              <br>
              <br>
              <br>
              <br>
...
</html><?php /**PATH C:\xampp\htdocs\DustBuster\resources\views/main_index.blade.php ENDPATH**/ ?>